...
const Banner = () => {
  ...
  const newTagAnimation = {
    ...animation,
    transform: isVisible && animationRef.current ? 'translateX(0)' : 'translateX(-100%)',
  ...
  return (
    <div ref={inViewRef} className="bg-no-repeat bg-center w-full h-screen overflow-x-hidden" style={{ backgroundImage: `url('../../public/assets/background.png')` }}>
    <Container>
